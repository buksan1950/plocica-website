 ...
 *   - Lokacija 1 (Tržnica, Narodni trg)  primary order line: +385 95 362 7218
...
export const WHATSAPP_NUMBER = "385953627218";

export const PHONE_DISPLAY = "+385 95 362 7218";
export const PHONE_TEL = `tel:${PHONE_DISPLAY.replace(/\s+/g, "")}`;

export const PHONE_TRZNICA_DISPLAY = "+385 95 362 7218";
